...
Car::Car(int column, int row): SubVehicle(column, row)
{
}

Car::Car(const Car &c) : SubVehicle(c)
{
}
...
{
	SubVehicle::operator=(c);
	return *this;
}

void Car::selfDraw(ConsoleHandle * &handle) const
{
...
void Car::selfDrawToBuffer(Buffer &b, int color) const {
